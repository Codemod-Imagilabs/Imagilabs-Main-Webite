      ...
      <div className="flex items-center space-x-4 md:space-x-8">
        ...
        <div className={isLight ? 'theme-is-light' : ''}>
          <button
            ...
            className="theme-toggle-btn text-brand-purple"
          >
            {/* Sun icon */}
            <svg className="toggle-icon toggle-sun" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            {/* Moon icon */}
            <svg className="toggle-icon toggle-moon" viewBox="0 0 24 24" fill="currentColor" stroke="none">
