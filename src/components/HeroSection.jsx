    ...
    >
      ...
      <div className="absolute inset-0 z-10 pointer-events-none">
        <div className="absolute top-[18%] left-[15%] opacity-90 animate-[float_6s_ease-in-out_infinite]">
          <div className="w-10 h-10 md:w-16 md:h-16 rounded-full bg-white/70 dark:bg-white/[0.08] backdrop-blur-2xl saturate-[1.6] flex justify-center items-center border border-white/90 dark:border-white/[0.12] shadow-[0_8px_32px_rgba(0,0,0,0.12),inset_0_1px_0_rgba(255,255,255,0.8)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
            <img src={reactIcon} alt="React" className="w-5 h-5 md:w-8 md:h-8 object-contain" />
          </div>
        </div>
        <div className="absolute top-[28%] right-[18%] opacity-90 animate-[float_7s_ease-in-out_infinite_1s]">
          <div className="w-10 h-10 md:w-16 md:h-16 rounded-full bg-white/70 dark:bg-white/[0.08] backdrop-blur-2xl saturate-[1.6] flex justify-center items-center border border-white/90 dark:border-white/[0.12] shadow-[0_8px_32px_rgba(0,0,0,0.12),inset_0_1px_0_rgba(255,255,255,0.8)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
            <img src={illustratorIcon} alt="Illustrator" className="w-5 h-5 md:w-8 md:h-8 object-contain" />
          </div>
        </div>
        <div className="absolute bottom-[25%] left-[25%] opacity-90 animate-[float_8s_ease-in-out_infinite_2s]">
          <div className="w-10 h-10 md:w-16 md:h-16 rounded-full bg-white/70 dark:bg-white/[0.08] backdrop-blur-2xl saturate-[1.6] flex justify-center items-center border border-white/90 dark:border-white/[0.12] shadow-[0_8px_32px_rgba(0,0,0,0.12),inset_0_1px_0_rgba(255,255,255,0.8)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
            <img src={figmaIcon} alt="Figma" className="w-5 h-5 md:w-8 md:h-8 object-contain" />
          </div>
        </div>
        <div className="absolute bottom-[15%] right-[15%] opacity-90 animate-[float_6.5s_ease-in-out_infinite_0.5s]">
          <div className="w-10 h-10 md:w-16 md:h-16 rounded-full bg-white/70 dark:bg-white/[0.08] backdrop-blur-2xl saturate-[1.6] flex justify-center items-center border border-white/90 dark:border-white/[0.12] shadow-[0_8px_32px_rgba(0,0,0,0.12),inset_0_1px_0_rgba(255,255,255,0.8)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
            <img src={dockerIcon} alt="Docker" className="w-5 h-5 md:w-8 md:h-8 object-contain" />
          </div>
        </div>
        <div className="absolute top-[48%] right-[10%] opacity-90 animate-[float_7.5s_ease-in-out_infinite_1.5s]">
          <div className="w-10 h-10 md:w-16 md:h-16 rounded-full bg-white/70 dark:bg-white/[0.08] backdrop-blur-2xl saturate-[1.6] flex justify-center items-center border border-white/90 dark:border-white/[0.12] shadow-[0_8px_32px_rgba(0,0,0,0.12),inset_0_1px_0_rgba(255,255,255,0.8)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
            <img src={githubIcon} alt="GitHub" className="w-5 h-5 md:w-8 md:h-8 object-contain dark:invert" />
          </div>
        </div>
      </div>
      ...
      <div className="relative z-30 flex flex-col items-center text-center px-4 max-w-6xl mx-auto">
        <h1 className="text-3xl md:text-7xl font-normal tracking-tight mb-8 md:mb-12 leading-tight">
          <span className="block mb-2 md:mb-6">Empowering Businesses</span>
              ...
              <span className="relative inline-flex overflow-hidden bg-white/60 dark:bg-white/[0.03] backdrop-blur-[40px] saturate-[2] px-6 md:px-10 py-2.5 md:py-4 rounded-full border border-white/80 dark:border-white/[0.12] shadow-[0_8px_40px_rgba(0,0,0,0.12),inset_0_1px_0_rgba(255,255,255,0.9)] dark:shadow-[0_20px_60px_rgba(0,0,0,0.5)] transition-all duration-500">
                ...
                >
                  {[...words, words[0]].map((word, i) => (
                    <div 
                      key={i} 
                      className="h-full w-full flex items-center justify-center text-transparent bg-clip-text bg-gradient-to-r from-gray-700 to-gray-900 dark:from-gray-100 dark:to-gray-400 whitespace-nowrap px-6 md:px-8 text-2xl md:text-6xl font-normal"
                    >
                      {word}
                    </div>
                  ))}
        ...
        <p className="text-gray-600 dark:text-gray-400 text-base md:text-xl mb-10 md:mb-12 max-w-3xl mx-auto leading-relaxed px-2">
